...
const ManageUsers = () => {
  ...
  const handleDelete = (user) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://pro-learn-server-lemon.vercel.app/users/${user._id}`, {
          method: 'DELETE'
        })
          .then(res => res.json())
          .then(data => {
  ...
  const handleAdmin = user => {
    fetch(`https://pro-learn-server-lemon.vercel.app/users/admin/${user._id}`, {
      method: 'PATCH'
    })
      .then(res => res.json())
      .then(data => {
  ...
  const handleInstructor = user => {
    fetch(`https://pro-learn-server-lemon.vercel.app/users/instructor/${user._id}`, {
      method: 'PATCH'
    })
      .then(res => res.json())
      .then(data => {
