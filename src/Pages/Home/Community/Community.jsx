...
const Community = () => {
  ...
  return (
    <div className='mt-16 md:mt-10'>
        <h2 className='text-center txt-xl md:text-3xl uppercase border-y-4 py-2 md:py-4 text-yellow-400'>Community</h2>
      <Swiper {...swiperOptions}>
        {sliderElement.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="grid grid-flow-row md:mb-2 h-80 md:h-96">
